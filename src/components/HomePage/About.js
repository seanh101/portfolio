      ...
      <div className="row mt-5">
        <div className="col-lg-8 offset-lg-2">
          ...
          <ul>
            ...
            <li>
              <strong>Soundify:</strong> Soundify is a playlist and song management web app developed with Django and Python. It offers full CRUD functionality for playlists and songs, authentication and authorization using Django's built-in system, and integration with the Spotify API for song information.
            </li>
            <li>
